export default {
  ...
  chat: {
    ...
    emptyState: 'Inicie uma conversa com o AUD',
    ...
    hermesHistory: 'Histórico AUD',
    historyScopeHint: 'Sessões do histórico AUD somente leitura, agrupadas por origem.',
...
jobTriggered: 'Job acionado',
  ...
  plugins: {
    title: 'Plugins',
    refresh: 'Atualizar',
    notice: 'Inventário somente leitura dos manifests de plugins AUD detectáveis. Os metadados de descoberta são lidos sem carregar código de plugin. No v1, ações de gerenciamento ficam na CLI; mudanças entram em vigor em novas sessões AUD.',
  ...
  models: {
    ...
    copilotAddDetected: 'Foi detectado um token OAuth do GitHub Copilot nesta máquina. Clique em Adicionar para ativar o Copilot no AUD.',
    ...
    copilotDeleteHintGhCli: 'O Copilot ficará oculto no AUD. Sua sessão no gh CLI não é afetada — `gh auth status` continuará indicando que está conectado.',
    copilotDeleteHintAppsJson: 'O Copilot ficará oculto no AUD. A extensão Copilot do VS Code continuará conectada.',
  ...
  skillsUsage: {
    ...
    subtitle: 'Acompanhe carregamentos e edições de habilidades nas sessões AUD',
    refresh: 'Atualizar',
  ...
  changelog: {
    ...
    new_0_5_17_9: 'Adicionar página de plugins AUD somente leitura',
    ...
    new_0_5_5_2: 'Adicionada página de histórico para sessões AUD',
