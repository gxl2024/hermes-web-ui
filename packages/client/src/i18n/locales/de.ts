export default {
  ...
  chat: {
    ...
    emptyState: 'Starten Sie eine Konversation mit AUD',
    ...
    hermesHistory: 'AUD-Verlauf',
    historyScopeHint: 'Schreibgeschützte AUD-Verlaufssitzungen, nach Quelle gruppiert.',
...
jobTriggered: 'Job ausgelost',
  ...
  plugins: {
    ...
    notice: 'Schreibgeschütztes Inventar erkennbarer AUD-Plugin-Manifeste. Discovery-Metadaten werden gelesen, ohne Plugin-Code zu laden. Verwaltungsaktionen bleiben in v1 im CLI; Änderungen gelten für neue AUD-Sitzungen.',
  ...
  models: {
    ...
    copilotAddDetected: 'Auf diesem Rechner wurde ein GitHub Copilot OAuth-Token erkannt. Klicken Sie auf „Hinzufügen", um Copilot in AUD zu aktivieren.',
    ...
    copilotDeleteHintGhCli: 'Copilot wird aus AUD ausgeblendet. Ihre gh CLI-Anmeldung bleibt erhalten — `gh auth status` zeigt weiterhin als angemeldet.',
    copilotDeleteHintAppsJson: 'Copilot wird aus AUD ausgeblendet. Ihre VS Code Copilot-Erweiterung bleibt angemeldet.',
  ...
  skillsUsage: {
    title: 'Skill-Nutzung',
    subtitle: 'Skill-Ladevorgänge und -Bearbeitungen aus AUD-Sitzungen verfolgen',
    refresh: 'Aktualisieren',
  ...
  changelog: {
    ...
    new_0_5_15_9: 'AUD Markdown-Medien-Rendering und Sync-Wiederholung korrigiert',
    ...
    new_0_5_17_3: 'Plugin-Erkennung auf Termux repariert durch Parsen des AUD-Shebangs zur Python-Lokalisierung',
    ...
    new_0_5_17_9: 'Schreibgeschuetzte AUD-Plugins-Seite hinzugefuegt',
    ...
    new_0_5_5_2: 'Verlaufsseite für AUD-Sitzungshistorie hinzugefügt',
    ...
    new_0_5_4_4: 'Fix web terminal AUD CLI availability after Docker deployment',
    ...
    new_0_5_4_7: 'Align usage analytics with AUD state DB schema',
    ...
    new_0_4_8_7: 'Fix login token validation using AUD session endpoint',
