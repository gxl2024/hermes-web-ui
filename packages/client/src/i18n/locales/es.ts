export default {
  ...
  chat: {
    ...
    emptyState: 'Inicia una conversacion con AUD',
    ...
    hermesHistory: 'Historial de AUD',
    historyScopeHint: 'Sesiones del historial de AUD, de solo lectura y agrupadas por origen.',
...
jobTriggered: 'Job ejecutado',
  ...
  plugins: {
    title: 'Plugins',
    refresh: 'Actualizar',
    notice: 'Inventario de solo lectura de manifests de plugins AUD detectables. Los metadatos de descubrimiento se leen sin cargar código de plugins. En v1, la gestión permanece en CLI; los cambios se aplican en nuevas sesiones AUD.',
  ...
  models: {
    ...
    copilotAddDetected: 'Se detectó un token OAuth de GitHub Copilot en este equipo. Haz clic en Agregar para habilitar Copilot en AUD.',
    ...
    copilotDeleteHintGhCli: 'Copilot se ocultará de AUD. Tu sesión de gh CLI no se verá afectada — `gh auth status` seguirá mostrando que estás conectado.',
    copilotDeleteHintAppsJson: 'Copilot se ocultará de AUD. La extensión Copilot de VS Code seguirá conectada.',
  ...
  skillsUsage: {
    ...
    subtitle: 'Sigue las cargas y ediciones de habilidades en sesiones de AUD',
    refresh: 'Actualizar',
  ...
  changelog: {
    ...
    new_0_5_17_9: 'Agregar página de plugins AUD de solo lectura',
    ...
    new_0_5_5_2: 'Añadida página de historial para sesiones AUD',
