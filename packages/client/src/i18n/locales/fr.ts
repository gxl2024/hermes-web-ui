export default {
  ...
  chat: {
    ...
    emptyState: 'Demarrer une conversation avec AUD',
    ...
    hermesHistory: 'Historique AUD',
    historyScopeHint: 'Sessions d’historique AUD en lecture seule, regroupées par source.',
...
jobTriggered: 'Job declenche',
  ...
  plugins: {
    title: 'Plugins',
    refresh: 'Actualiser',
    notice: 'Inventaire en lecture seule des manifests de plugins AUD détectables. Les métadonnées de découverte sont lues sans charger le code des plugins. En v1, la gestion reste dans le CLI; les changements prennent effet dans les nouvelles sessions AUD.',
  ...
  models: {
    ...
    copilotAddDetected: 'Un token OAuth GitHub Copilot a été détecté sur cette machine. Cliquez sur Ajouter pour activer Copilot dans AUD.',
    ...
    copilotDeleteHintGhCli: 'Copilot sera masqué dans AUD. Votre connexion gh CLI n\'est pas affectée — `gh auth status` indiquera toujours que vous êtes connecté.',
    copilotDeleteHintAppsJson: 'Copilot sera masqué dans AUD. Votre extension Copilot de VS Code reste connectée.',
  ...
  skillsUsage: {
    ...
    subtitle: 'Suivre les chargements et modifications de compétences dans les sessions AUD',
    refresh: 'Actualiser',
  ...
  changelog: {
    ...
    new_0_5_17_9: 'Ajouter une page de plugins AUD en lecture seule',
    ...
    new_0_5_5_2: 'Ajout d\'une page d\'historique pour les sessions AUD',
