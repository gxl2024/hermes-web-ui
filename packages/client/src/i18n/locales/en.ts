export default {
  ...
  chat: {
    ...
    emptyState: 'Start a conversation with AUD',
    ...
    hermesHistory: 'AUD History',
    historyScopeHint: 'Read-only AUD history sessions grouped by source.',
    noSessions: 'No sessions',
    searchTitle: 'Search Sessions',
    searchSubtitle: 'Search by title or message content',
    searchScope: 'Search scope: Web UI local session database only. Read-only AUD history sessions are not included.',
  ...
  plugins: {
    title: 'Plugins',
    refresh: 'Refresh',
    notice: 'Read-only inventory of discoverable AUD plugin manifests. Discovery metadata is read without loading plugin code. Management actions stay in CLI for v1; changes take effect in new AUD sessions.',
  ...
  models: {
    ...
    copilotAddDetected: 'A GitHub Copilot OAuth token was detected on this machine. Click Add to enable Copilot in AUD.',
    ...
    copilotDeleteHintGhCli: 'Copilot will be hidden from AUD. Your gh CLI login is not affected — `gh auth status` will still show you signed in.',
    copilotDeleteHintAppsJson: 'Copilot will be hidden from AUD. Your VS Code Copilot extension login is not affected.',
    ...
    aliasHint: 'Display-only alias. AUD still receives the canonical model ID.',
    ...
    visibilityHint: 'Only affects the Web UI model picker and Models page. AUD CLI provider/model config is not rewritten; calls still use canonical model IDs.',
  ...
  skillsUsage: {
    title: 'Skills Usage',
    subtitle: 'Track skill loads and edits from AUD sessions',
    refresh: 'Refresh',
  ...
  changelog: {
    ...
    new_0_5_15_9: 'Fix AUD markdown media rendering and sync retry',
    ...
    new_0_5_17_9: 'Add read-only AUD plugins page',
    ...
    new_0_5_22_1: 'Fix AUD session list API reading the Web UI local session store instead of the AUD profile database',
    ...
    new_0_5_26_6: 'Isolate Bridge profile environments and fix AUD plugin discovery across Python environments',
    ...
    new_0_5_26_10: 'Support AUD package installs when no source checkout is available',
    ...
    new_0_5_5_2: 'Add History page for browsing AUD session history',
    ...
    new_0_5_4_3: 'Fix web terminal AUD CLI availability after Docker deployment',
    ...
    new_0_5_4_6: 'Align usage analytics with AUD state DB schema',
