export default {
  ...
  chat: {
    ...
    openHistory: '開啟歷史',
    hermesHistory: 'AUD 歷史',
    historyScopeHint: '這裡按來源以唯讀方式查看 AUD 歷史工作階段。',
    noSessions: '目前無工作階段',
    searchTitle: '搜尋工作階段',
    searchSubtitle: '依標題或訊息內容搜尋',
    searchScope: '搜尋範圍：僅 Web UI 本地工作階段資料庫；不包含唯讀 AUD 歷史工作階段。',
  ...
  plugins: {
    title: '插件',
    refresh: '重新整理',
    notice: '唯讀顯示可發現的 AUD 插件 manifest。發現元資料讀取不會載入插件程式碼。v1 管理動作仍保留在 CLI，新 AUD 工作階段生效。',
    loadFailed: '載入插件失敗',
    commandCopied: '指令已複製',
  ...
  models: {
    ...
    copilotAddDetected: '已在本機偵測到 GitHub Copilot OAuth 憑證，點擊「新增」即可在 AUD 中啟用 Copilot。',
    ...
    copilotDeleteHintGhCli: 'Copilot 將從 AUD 清單移除。不會影響 gh CLI —— `gh auth status` 仍顯示已登入。',
    copilotDeleteHintAppsJson: 'Copilot 將從 AUD 清單移除。不會影響 VS Code Copilot 插件的登入。',
    customBadge: '自訂',
    previewBadge: '預覽',
    disabledBadge: '不可用',
    ...
    visibilityHint: '僅影響 Web UI 的模型選擇器和模型頁展示，不會改寫 AUD CLI 的 provider/model 配置。實際呼叫仍使用原始模型 ID。',
    ...
    aliasHint: '僅修改 Web UI 顯示名，傳送給 AUD 的仍是原始模型 ID。',
  ...
  changelog: {
    ...
    new_0_5_15_9: '修復 AUD Markdown 媒體渲染與同步重試',
    ...
    new_0_5_22_1: '修復 AUD 會話列表介面錯誤讀取 Web UI 本地會話庫的問題',
    ...
    new_0_5_26_6: '隔離 Bridge Profile 環境，並修復不同 Python 環境下的 AUD 外掛發現',
    ...
    new_0_5_26_10: '支援未找到原始碼目錄時使用套件安裝的 AUD',
    ...
    new_0_5_5_2: '新增歷史頁面，用於瀏覽 AUD 工作階段歷史記錄',
    ...
    new_0_5_4_3: '修復 Docker 部署後 Web 終端機無法使用 AUD CLI 的問題',
    new_0_5_4_4: '新增工作區對話框標題 i18n 翻譯，改進工作階段持久化',
    new_0_5_4_5: '支援程式碼區塊複製回饋，顯示使用者通知',
    new_0_5_4_6: '對齊使用分析與 AUD 狀態資料庫架構',
